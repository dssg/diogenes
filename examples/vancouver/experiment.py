...
exp = ae.subset_over(
    ...
    interval_train_window_size=365,
    interval_test_window_start=np.datetime64('2012-01-01'),
    interval_test_window_size=365,
    interval_inc_value=365,
    interval_expanding=True,
    label_interval_train_window_start=np.datetime64('2013-01-01'),
    label_interval_train_window_size=365,
    label_interval_test_window_start=np.datetime64('2013-01-01'),
    label_interval_test_window_size=365,
